...
// the /this-week route (React) to compute a rolling "next 7 days" summary.
//
...
// page components in index.html whenever a date is added, changed, or removed
// there — there's no build step tying them together automatically.
const EVENTS = [
    {
